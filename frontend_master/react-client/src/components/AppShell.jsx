...
export default function AppShell() {
  ...
  useEffect(() => {
    ...
    var firstName = userData ? JSON.parse(userData).firstName : "";
    ...
    <div className="home-page">
      ...
      <header className="home-topbar">
        ...
        <div className="home-left">
          ...
          <img src="SN_logo.png" alt="LB" className="home-logo" />
        ...
        <div className="home-right">
          {/* Profile icon */}
          <button className="icon-btn" aria-label="Profile" onClick={() => nav("/profile")}>
            <svg
              width="22"
              height="22"
              viewBox="0 0 24 24"
